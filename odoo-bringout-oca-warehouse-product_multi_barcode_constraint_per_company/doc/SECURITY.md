...
Access control and security definitions in product_multi_barcode_constraint_per_company.
...
- **[ir_rule.xml](../product_multi_barcode_constraint_per_company/security/ir_rule.xml)**
